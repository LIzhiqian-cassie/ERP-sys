...
document.getElementById ('danhao').blur();  
                        ...
                        <div class="card-body">
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                while($row2 = $result2->fetch_assoc()) {
                                                  $sql3 = "SELECT num FROM purchase_items_list where (product_id ='" . $row["product_id"] ."' AND purchasing_id = '" . $_GET['id'] . "')";
                                                  $result3 = $conn->query($sql3);
                                                //   $sql4 = "SELECT num FROM purchase_items_list where product_id='". $row['product_id'] ."'";
                                                //   $result4 = $conn->query($sql4);
                                                  
                                                  while($row3 = $result3->fetch_assoc()) {
                                                    echo "<tr><td>" .$row["purchasing_id"] ."</td><td>" .$row["product_id"] ."</td><td>" .$row2["name"] ."</td><td>$" .$row2["p2"] ."</td><td>" .$row["quantity"] ."</td><td>" .$row3["num"] ."</td>";
                                                    // echo $row["num"];
                            ...
                            <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								...
								<button type="submit" name="confirminbound" class="btn btn-primary ml-1" value="submit" >Confirm</button>
                                </form>                              
